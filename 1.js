! function (t, e) {
    ...
    function Nb(e, r) {
        ...
        void 0 === r && (r = 1.70158);
        var t = "out" === e ? fm : "in" === e ? function (t) {
            return 1 - fm(1 - t)
        } : Lb(fm);
    ...
    var Yt = function (n) {
        ...
        return e.to = function to(t, e, r) {
            ...
            for (var r, i = [], n = xt(t), a = this._first, s = q(e); a;) a instanceof $t ? fa(a._targets, n) && (s ? (!qt || a._initted && a._ts) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e : !e || a.isActive()) && i.push(a) : (r = a.getTweensOf(n, e)).length && i.push.apply(i, r), a = a._next;
            return i
    ...
    function Yb(t, e, r, i, n, a) {
        var s, o, u, h = (t._pt && t._ptCache || (t._ptCache = {}))[e];
        if (!h)
            for (h = t._ptCache[e] = [], o = t._ptLookup, u = t._targets.length; u--;) {
                if ((s = o[u][e]) && s.d && s.d._pt)
    ...
    var qt, Ut, Vt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
            p(i) && (i = i(n || 0, t, a));
            var l, f = t[e],
                d = "get" !== r ? r : p(f) ? h ? t[e.indexOf("set") || !p(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](h) : t[e]() : f,
                _ = p(f) ? h ? Wt : Zt : Gt;
            if (o(i) && (~i.indexOf("random(") && (i = hb(i)), "=" === i.charAt(1) && (!(l = ea(d, i) + (Ra(d) || 0)) && 0 !== l || (i = l))), d !== i || Ut) return isNaN(d * i) || "" === i ? (f || e in t || N(e, i), function _addComplexStringPropTween(t, e, r, i, n, a, s) {
    ...
    var $t = function (R) {
        function Tween(e, r, i, n) {
            ...
            if (a._targets = C.length ? $(C) : O("GSAP target " + e + " not found. ", !Y.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = T, w || b || v(m) || v(g)) {
                if (r = a.vars, (o = a.timeline = new Yt({
                    ...
                    for (u = 0; u < l; u++)(h = oa(r, Kt)).stagger = 0, P && (h.yoyoEase = P), p && mt(h, p), d = C[u], h.duration = +Qt(m, _assertThisInitialized(a), u, d, C), h.delay = (+Qt(g, _assertThisInitialized(a), u, d, C) || 0) - a._delay, !b && 1 === l && h.delay && (a._delay = g = h.delay, a._start += g, h.delay = 0), o.to(d, h, _ ? _(u, d, C) : 0), o._ease = zt.none;
            ...
            return !0 !== T || B || (qt = _assertThisInitialized(a), I.killTweensOf(C), qt = 0), Da(M, _assertThisInitialized(a), i), r.reversed && a.reverse(), r.paused && a.paused(!0), (y || !m && !w && a._start === da(M._time) && t(y) && function _hasNoPausedAncestors(t) {
        ...
        return e.render = function render(t, e, r) {
            ...
            var i, n, a = Math.min(this._dur, (this._dp._time - this._start) * this._ts);
            if (this._initted || Xt(this, a), i = this._ease(a / this._dur), s(t)) {
                for (n in t)
                    if (Yb(this, n, t[n], e ? e[n] : 0, i, a)) return this.resetTo(t, e, r)
            ...
            if (this.timeline) {
                ...
                return this.timeline.killTweensOf(t, e, qt && !0 !== qt.vars.overwrite)._first || mb(this), this.parent && r !== this.timeline.totalDuration() && Ka(this, this._dur * this.timeline._tDur / r, 0, 1), this
            }
    ...
    var ue = {
        ...
        quickTo: function quickTo(t, r, e) {
            var i, n = he.to(t, mt(((i = {})[r] = "+=0", i.paused = !0, i), e || {}));
            return function (t, e) {
    ...
    function Fd(t, e, r, i) {
        var n;
        return _e || wd(), e in Ue && "transform" !== e && ~(e = Ue[e]).indexOf(",") && (e = e.split(",")[0]), Fe[e] && "transform" !== e ? (n = He(t, i), n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : Je(td(t, Xe)) + " " + n.zOrigin + "px") : (n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(") || (n = Ge[e] && Ge[e](t, e, r) || td(t, e) || aa(t, e) || ("opacity" === e ? 1 : 0)), r && !~(n + "").trim().indexOf(" ") ? Ed(t, e, n, r) + r : n
    }
    ...
    var sr, or, ur, hr = {
        ...
        init: function init(t, e, r, i, n) {
            ...
            for (d in _e || wd(), e)
                ...
                if (m || (u || 0 === u) && (h || 0 === h) && !qe.test(s) && d in w) u = u || 0, (_ = (a + "").substr((h + "").length)) !== (p = Ra(s) || (d in Y.units ? Y.units[d] : _)) && (h = Ed(t, d, a, p)), this._pt = new oe(this._pt, m ? v : w, d, h, (c ? ea(h, c + u) : u) - h, m || "px" !== p && "zIndex" !== d || !1 === e.autoRound ? dd : gd), this._pt.u = p || 0, _ !== p && "%" !== p && (this._pt.b = a, this._pt.r = fd);
    ...
    }), Ue[ur[13]] = sr + "," + or, ba("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", function (t) {
        var e = t.split(":");
        Ue[e[1]] = ur[e[0]]
